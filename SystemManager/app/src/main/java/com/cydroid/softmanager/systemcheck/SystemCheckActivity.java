...
public class SystemCheckActivity extends BaseActivity implements IMemoryCleanNativeCallback, ScoreCountView.ScoreChangeListener {
    ...
    public void onScoreChange(final int score) {
        ...
        ColorUtils.colorChangeAnim(mTopBg, SystemCheckActivity.this, beforeColor, mCurrentColor);
    }
    ...
    private void initViews(){
        setSecondLayoutVisibility(View.GONE);
    ...
    private void resetStatusBarColor(){
        if (isNeedChangeColor){
            ...
            ColorUtils.setStatusBarColor(this, color_A1);
        }else {
            mCurrentColor = ColorUtils.getCurrentColorByScore(mSystemScore);
            ColorUtils.setStatusBarColor(this, mCurrentColor);
        }
    }
    ...
    private void setCurrentBackgroundColor(){
        if (isNeedChangeColor) {
            ...
            ColorUtils.changeBackgroundColor(mTopBg, SystemCheckActivity.this, color_A1);
        }else {
            mCurrentColor = ColorUtils.getCurrentColorByScore(mSystemScore);
            ColorUtils.changeBackgroundColor(mTopBg, SystemCheckActivity.this, mCurrentColor);
        }
    }
