...
public class ScoreCountView extends View {
    ...
    private void getAttributes(Context context, AttributeSet attrs) {
        ...
        mScoreSize = typedArray.getDimensionPixelSize(R.styleable.ScoreCountView_number_size, UnitUtil.sp2px(context, 50f));
        ...
        mUnitSize = typedArray.getDimensionPixelSize(R.styleable.ScoreCountView_unit_size, UnitUtil.sp2px(context, 18f));
        ...
        mScoreUnitSize = typedArray.getDimensionPixelSize(R.styleable.ScoreCountView_score_view_unit_size,UnitUtil.sp2px(context, 16f));


        mHintSize = typedArray.getDimensionPixelSize(R.styleable.ScoreCountView_hint_size, UnitUtil.sp2px(context, 18f));
        ...
        mSize = typedArray.getDimensionPixelSize(R.styleable.ScoreCountView_size, (int) UnitUtil.dip2px(context, 160f));
        ...
        exCircleDrawable =  getResources().getDrawable(R.drawable.circle01);

        innerCircleDrawable = getResources().getDrawable(R.drawable.circle02);
    ...
    private void drawScore(Canvas canvas) {
        ...
        //draw 分
        float ratio = mHundredBits == 0? 2.5f : 3;
        switch (mTextGravity) {
    ...
    public void setCircleRotateAngle(int checkItem){
        if (checkItem <= SystemCheckItem.CHECK_OVER / 2){
            mAngleDelta = checkItem * 2;
        }else {
            mAngleDelta = (SystemCheckItem.CHECK_OVER - checkItem + 1) * 2;
        }
    }
}
