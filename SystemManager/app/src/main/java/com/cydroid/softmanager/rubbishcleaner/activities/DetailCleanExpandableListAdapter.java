...
import com.cydroid.softmanager.rubbishcleaner.common.ChildHolder;
...
import com.cydroid.softmanager.rubbishcleaner.common.GroupHolder;
import com.cydroid.softmanager.rubbishcleaner.common.GroupInfo;
...
public class DetailCleanExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private final int mCleanType;
    private final int mRubbishType;
    
	private final ArrayList<GroupInfo> mGroupList = new ArrayList<GroupInfo>();
    private final HashMap<Integer, ArrayList<RubbishInfo>> mGroupListMap =
            new HashMap<Integer, ArrayList<RubbishInfo>>();

	private static final String TAG = "DetailCleanExpandableListAdapter";
