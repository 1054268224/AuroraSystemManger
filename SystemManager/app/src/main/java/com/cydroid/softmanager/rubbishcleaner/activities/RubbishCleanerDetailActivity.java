...
import com.cydroid.softmanager.BaseCyeeActivity;
import com.cydroid.softmanager.R;
import com.cydroid.softmanager.rubbishcleaner.activities.RubbishCleanerDataManager.GroupKeyInfo;
...
import com.cydroid.softmanager.rubbishcleaner.interfaces.OnSelectedListener;
import com.cydroid.softmanager.rubbishcleaner.interfaces.RubbishCleanerDelListener;
import com.cydroid.softmanager.rubbishcleaner.util.StringFilterUtil;
import com.cydroid.softmanager.ui.UiAnimator;
...
public class RubbishCleanerDetailActivity extends BaseCyeeActivity
    ...
    private static int mCleanType;
    private static int mRubbishType;
    ...
    private void addCleanButton() {
        ...
        int width = mResources.getDimensionPixelSize(R.dimen.cleanbutton_width);
    ...
    private class IntentDialog {
        ...
        private final RubbishInfo rInfo;
        ...
        private void updateAdapterList() {
            ...
            if (mRubbishType == CleanTypeConst.APK) {
                mRubbishCleanerDataManager.syncLocalDatabase(RubbishCleanerDataManager.APK_QUERY_TOKEN,
                        rInfo.db_id);
            }
        ...
        private void gotoInstallApk(String path) {
            ...
            Uri contentUri = FileProvider.getUriForFile(mContext, "com.cydroid.softmanager.rubbishcleaner.fileprovider", newFile);
    ...
    private class ConfirmDialog {
        ...
        private void updateAdapterList() {
            ...
            if (mRubbishType == DeeplyCleanTypeConst.BIGFILE) {
                mRubbishCleanerDataManager.syncLocalDatabase(RubbishCleanerDataManager.BIGFILE_QUERY_TOKEN,
                        rInfo.db_id);
            }
