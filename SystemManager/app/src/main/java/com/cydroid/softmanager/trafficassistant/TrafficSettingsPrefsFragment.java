...
public class TrafficSettingsPrefsFragment extends CyeePreferenceFragment {
    ...
    private CyeeAlertDialog.Builder mHotSpotSetDialogBuiler;
    private CyeeButton mHotspotPositeBtn;
    ...
    private void createUserDefineDialog() {
        ...
        mHotSpotSetDialogBuiler = new CyeeAlertDialog.Builder(mContext);
        ...
        CyeeAlertDialog hotSpotSetDialog = mHotSpotSetDialogBuiler.create();
