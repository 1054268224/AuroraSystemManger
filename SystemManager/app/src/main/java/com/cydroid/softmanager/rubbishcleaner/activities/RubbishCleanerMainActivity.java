...
public class RubbishCleanerMainActivity extends BaseCyeeActivity
    ...
    private static final String TAG = "CyeeRubbishCleaner/RubbishCleanerMainActivity";
    ...
    private void execAnimatorBeforeDel() {
        ...
        /*mCmSupportText.setVisibility(View.INVISIBLE);*/
        try {
    ...
    public void onScanItem(Object obj) {
        showDetailsWhenScanning(obj);
    }

    public void onFindItem(Object obj) {
