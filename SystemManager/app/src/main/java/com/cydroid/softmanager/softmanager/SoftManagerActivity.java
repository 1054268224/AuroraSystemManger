 ...
 */
public class SoftManagerActivity extends BaseActivity implements OnItemClickListener, SoftHelperUtils.StorageInfoUpdateCallback{
...
//            int progress = (int) ((float) (sdCardInfo.mTotal - sdCardInfo.mFree) / sdCardInfo.mTotal * 100);
    ...
    private void initData() {
        ...
        int[] resIds = new int[] {R.drawable.icon_auto_start, R.drawable.icon_soft_uninstall,
                R.drawable.icon_soft_freeze, R.drawable.icon_soft_applock, R.drawable.icon_soft_default};
        //Gionee <GN_Oversea_Bug> <fengpeipei> <20161123> for applock begin
        if(!mIsAppLockSupport){
        	...
        	titles = titlestmp;
        	resIds = new int[] {R.drawable.icon_auto_start, R.drawable.icon_soft_uninstall,
                    R.drawable.icon_soft_freeze, R.drawable.icon_default_app};
        }
        ...
        if (Consts.cyCXFlag && mIsAppLockSupport){
            ...
            titles = titlestmp;
            resIds = new int[] { R.drawable.icon_soft_uninstall,
    ...
    private void initIntents() {
        Intent[] names = new Intent[] {new Intent(this, AutoStartMrgActivity.class),
                new Intent(this, UninstallAppActivity.class), new Intent(this, FreezedAppActivity.class),
                new Intent(this, AppLockManagerActivity.class), new Intent(this, DefaultSoftMrgActivity.class)};
        //Gionee <GN_Oversea_Bug> <fengpeipei> <20161123> for applock begin
        if(!mIsAppLockSupport){
        	names = new Intent[] {new Intent(this, AutoStartMrgActivity.class),
                    new Intent(this, UninstallAppActivity.class), new Intent(this, FreezedAppActivity.class), new Intent(this, DefaultSoftMrgActivity.class)};
        }
        //Gionee <GN_Oversea_Bug> <fengpeipei> <20161123> for applock end
        ...
        if(Consts.cyCXFlag && mIsAppLockSupport){
            names = new Intent[] {
                    new Intent(this, UninstallAppActivity.class), new Intent(this, AppLockManagerActivity.class), new Intent(this, DefaultSoftMrgActivity.class)};
        }
        //Chenyee guoxt modify for CSW1703CX-919 end
    ...
    private void setActionBarCustomView() {
        ...
        */
        ...
        img.setImageResource(R.drawable.icon_soft_move);
