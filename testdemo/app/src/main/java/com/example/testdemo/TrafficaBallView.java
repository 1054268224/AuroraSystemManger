...
public class TrafficaBallView extends View {
     ...
     * @param context
     */
    public TrafficaBallView(Context context) {
        super(context);
     ...
     * @param defStyleAttr
     */
    public TrafficaBallView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        flowPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        flowPaint.setAntiAlias(true);
        flowPaint.setTextSize(80);
        flowPaint.setStrokeWidth(6);
    ...
    private void drawWave(Canvas canvas){
        ...
        setBackgroundColor(mContext.getResources().getColor(R.color.blue));
        // 计算当前油量线和水平中线的距离
